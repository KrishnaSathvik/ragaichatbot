...
def process_kb_directory(kb_path: Path) -> List[Dict[str, Any]]:
    ...
    for file_path in kb_path.rglob("*"):
        ...
        try:
            ...
            metadata['file_path'] = str(file_path.relative_to(Path("kb")))
...
def main():
    ...
    data_eng_path = Path("kb/data_eng")
    ...
    if not all_docs:
        print("No documents found! Make sure you have .md/.txt files in kb/ai_ml/ and kb/data_eng/")
        return
